...
with sqlite3.connect('pv.db') as db:
    cursor = db.cursor()
...
def firstTimeScreen():
    ...
    lb1 = Label(window, text='Create Master Password')
    ...
    lb2 = Label(window, text="Re-enter Password")
    ...
    def savePassword():
        if txt.get() == txt1.get():
            ...
            lb1.config(text="Passwords don't match")
